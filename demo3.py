...
print(asyncio.run(retriever.ainvoke("加菲猫")))
async def main():
    # 使用 await 关键字等待异步方法完成
    cat = await vector_store.asimilarity_search_with_score("加菲猫")
    print(cat)

    dog = await vector_store.asimilarity_search("拉布拉多")
    print(dog)
